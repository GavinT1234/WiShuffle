          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 rounded-full bg-[#aa3bff] flex items-center justify-center text-white font-bold text-2xl mb-4">
                  {step.number}
                </div>
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-8 left-full w-full h-1 bg-[#aa3bff]/30 -ml-8"></div>
              )}
            </div>
          ))}
        </div>
